...
def play_song() -> None:
    # ✅ FORCE TYPE (fix Instance error)
    instance = cast(vlc.Instance, vlc.Instance("--aout=directsound"))
    ...
    while True:
        ...
        try:
            # ✅ FORCE TYPE (fix media_player_new + set_media error)
            player = cast(vlc.MediaPlayer, instance.media_player_new())
